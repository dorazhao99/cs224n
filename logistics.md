...
#### Ethics-related questions: For guidance on projects dealing with ethical questions, or ethical questions that arise during your project, please contact Benji Xie (benjixie@stanford.edu) or Regina Wang (reginalw@stanford.edu).
### Practicalities
...
## Office Hours
- Attending OHs: Chris Manning's OH's should be booked through Calendly. Every weekday, TA office hours are offered both remotely through Zoom and in-person at the same time.
- Time and location: are listed in the calendar at the bottom of this page. The Zoom link for remote office hours is on Ed (see pinned "Welcome to CS224n!" post).
- Access: The exterior doors of the buildings lock at 5:30pm, so for evening office hours please remember to bring your Stanford ID so that you can access the respective rooms.
- Staff information: Each staff member's schedule and areas of expertise are listed in the staff information section below.
